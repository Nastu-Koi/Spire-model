...
- [动作、效果与目标编码](docs/ACTION_ENCODING.md)：原语、数值、对象绑定、随机、顺序与后续选择；附 [21 个 JSON 示例](specs/action_semantics_v1.examples.json)。
- [全流程动作与接口映射](docs/ACTION_CATALOG.md)：地图、战斗、药水、商店、奖励、营火、公共选择，以及现有 17 个命令的兼容缺口。
- [问号事件逐项核对](docs/EVENT_ACTIONS.md)：57 个事件的阶段、合法动作、锁定条件和子交互；水晶球、假商人等特殊流程单列。
- [开局与远古之民](docs/ANCIENT_ACTIONS.md)：8 位远古之民的 102 个静态选项族、子选择和结局处理。
